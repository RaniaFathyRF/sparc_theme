...
if($page == 'privacy_notice'){
	echo "<title>Privacy Notice</title>";
}
if($page == 'legal_notice'){
	echo "<title>Legal Notice</title>";
}
...
<div id="main">
	...
	<div class="container">
		<section id="primary" class="content-full-width">
			...
			<?php 
				if($page == 'technology'){
					echo '<div id="technology_page"></div>';
					get_template_part('template-parts/technology');
				}
				if($page == 'about'){
					echo '<div id="about_page"></div>';
					get_template_part('template-parts/about');
				}
				if($page == 'contact'){
					echo '<div id="contact_page"></div>';
					get_template_part('template-parts/contact');
				}
				if($page == 'privacy_notice'){
					get_template_part('template-parts/privacy_notice');
				}
				if($page == 'legal_notice'){
					get_template_part('template-parts/legal_notice');
				}
			?>
