    ...
    <div class="aligncenter wpb_column vc_column_container vc_col-sm-12">
        <div class="vc_column-inner ">
            ...
            <div class="ult-animation  ult-animate-viewport  ult-no-mobile " data-animate="fadeInDown" data-animation-delay="0.5" data-animation-duration="1" data-animation-iteration="1" style="opacity:0;" data-opacity_start_effect="">
                ...
                <h2 class="aligncenter">About <img style="display: inline;height: 30px;position: relative;top: 6px;" src="<?php echo esc_url( wp_get_attachment_url( get_theme_mod( 'custom_logo' ) ) ); ?>" alt="Logo" title="Logo"></h2>
                    ...
                    <div class="vc_column-inner ">
                        <div class="wpb_wrapper">
                            <figure class="wpb_wrapper vc_figure">
                                <div class="vc_single_image-wrapper   vc_box_border_grey"><img width="1170" height="500" src="<?php echo get_field('first_text_section_image', $configuration)["url"]; ?>" class="vc_single_image-img attachment-full" alt="" loading="lazy" srcset="<?php echo get_field('first_text_section_image', $configuration)["url"]; ?> 1170w, <?php echo get_field('first_text_section_image', $configuration)["url"]; ?> 300w, <?php echo get_field('first_text_section_image', $configuration)["url"]; ?> 768w, <?php echo get_field('first_text_section_image', $configuration)["url"]; ?> 1024w" sizes="(max-width: 1170px) 100vw, 1170px"></div>
                            </figure>
                        </div>
                    </div>
                </div>
